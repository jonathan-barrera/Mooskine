...
//  Mooskine
//
//  Created by Jonathan Barrera on 11/26/18.
...
class UpdateToAttributedStringPolicy: NSEntityMigrationPolicy {
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        // Get the updated destination Note
        ...
        // Use the original source Note instance and instantiate a new NSAttributedString using the original string
